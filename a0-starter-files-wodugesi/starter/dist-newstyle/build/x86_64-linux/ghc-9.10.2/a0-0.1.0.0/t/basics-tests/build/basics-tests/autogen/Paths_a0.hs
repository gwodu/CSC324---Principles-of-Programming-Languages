...
-- at runtime using the environment variable a0_bindir.
...
-- environment variable a0_libdir.
...
-- using the environment variable a0_dynlibdir.
...
-- runtime using the environment variable a0_datadir.
...
-- using the environment variable a0_sysconfdir.
...
bindir     = "/h/u14/c1/00/wodugesi/.cabal/bin"
libdir     = "/h/u14/c1/00/wodugesi/.cabal/lib/x86_64-linux-ghc-9.10.2-aac9/a0-0.1.0.0-inplace-basics-tests"
dynlibdir  = "/h/u14/c1/00/wodugesi/.cabal/lib/x86_64-linux-ghc-9.10.2-aac9"
datadir    = "/h/u14/c1/00/wodugesi/.cabal/share/x86_64-linux-ghc-9.10.2-aac9/a0-0.1.0.0"
libexecdir = "/h/u14/c1/00/wodugesi/.cabal/libexec/x86_64-linux-ghc-9.10.2-aac9/a0-0.1.0.0"
sysconfdir = "/h/u14/c1/00/wodugesi/.cabal/etc"

getBinDir     = catchIO (getEnv "a0_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "a0_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "a0_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "a0_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "a0_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "a0_sysconfdir") (\_ -> return sysconfdir)
